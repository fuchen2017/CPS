...
<h3>交談</h3>
		...
		<?php if($dsc_first !=''){?>
            ...
            <div class="chat-1" id="robot_dsc">                
                <IFRAME src="robot_img.php?dsc=<?php echo $dsc_first;?>&head_type=<?php echo $head_type;?>" width="100"  scrolling="no" frameborder="0"></IFRAME>
          <!--大頭貼-->             
